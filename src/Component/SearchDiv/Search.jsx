...
const Search = () => {
  return (
    <div className='search grid gap-7 bg-greyIsh rounded-[10px] p-12 mt-[150px]'>
      <form action="">
        <div className='first-div flex justify-between items-center rounded-[8px] gap-6 bg-white p-5 shadow-lg shadow-greyIsh-700'>
      ...
      <div className="sec-div flex flex-wrap items-center gap-12 justify-center">
